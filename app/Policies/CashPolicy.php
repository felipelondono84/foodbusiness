...
class CashPolicy
{
    ...
    {
        return $user->can('delete_any_cash');
    }
    ...
    {
        return $user->can('force_delete_cash');
    }
     ...
     */
    public function replicate(User $user, Cash $cash): bool
    {
